    ...
    public static class MensajeServidorHelper
    {
        ...
        private static readonly Dictionary<string, Func<string>> MapaMensajes =
            new Dictionary<string, Func<string>>(StringComparer.Ordinal)
            {
                ...
                ["El correo y el usuario ya están registrados."] = () => LangResources.Lang.errorTextoCorreoUsuarioRegistrados,
                ...
                ["El correo o usuario ya está registrado."] = () => LangResources.Lang.errorTextoCorreoUsuarioRegistrado,
                ...
                ["No fue posible procesar la recuperación de la cuenta."] = () => LangResources.Lang.errorTextoProcesarSolicitudRecuperacion,
                ["Ocurrió un problema al iniciar la recuperación de la cuenta."] = () => LangResources.Lang.errorTextoServidorInicioRecuperacion,
                ["Ocurrió un error inesperado al solicitar la recuperación de la cuenta."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ...
                ["No fue posible reenviar el código de recuperación."] = () => LangResources.Lang.errorTextoProcesarSolicitudReenvio,
                ["Ocurrió un problema al reenviar el código de recuperación."] = () => LangResources.Lang.errorTextoServidorReenviarCodigo,
                ["Ocurrió un error inesperado al reenviar el código de recuperación."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ...
                ["Ocurrió un error inesperado al confirmar el código de recuperación."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ...
                ["Ocurrió un error inesperado al actualizar la contraseña."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["No fue posible obtener los avatares solicitados."] = () => LangResources.Lang.errorTextoProcesarSolicitudAvatares,
                ["No fue posible recuperar el catálogo de avatares."] = () => LangResources.Lang.errorTextoServidorCatalogoAvatares,
                ["Ocurrió un problema al obtener el catálogo de avatares."] = () => LangResources.Lang.errorTextoServidorCatalogoAvataresDetalle,
                ["Ocurrió un error inesperado al obtener los avatares."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["No fue posible obtener la clasificación solicitada."] = () => LangResources.Lang.errorTextoProcesarSolicitudAvatares,
                ["No fue posible recuperar la clasificación de jugadores."] = () => LangResources.Lang.errorTextoServidorCatalogoAvatares,
                ["Ocurrió un problema al obtener la clasificación de jugadores."] = () => LangResources.Lang.errorTextoServidorCatalogoAvataresDetalle,
                ["Ocurrió un error inesperado al obtener la clasificación."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["Los datos proporcionados no son válidos para reenviar el código."] = () => LangResources.Lang.errorTextoServidorSolicitudCambioContrasena,
                ["No fue posible reenviar el código de verificación."] = () => LangResources.Lang.errorTextoProcesarSolicitudReenvio,
                ["Ocurrió un problema al reenviar el código de verificación."] = () => LangResources.Lang.errorTextoServidorReenviarCodigo,
                ["Ocurrió un error inesperado al reenviar el código de verificación."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["Los datos proporcionados no son válidos para obtener el perfil."] = () => LangResources.Lang.errorTextoServidorCatalogoAvatares,
                ...
                ["Ocurrió un error inesperado al obtener el perfil."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ...
                ["Ocurrió un error inesperado al actualizar el perfil."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["Los datos proporcionados no son válidos para solicitar el código."] = () => LangResources.Lang.errorTextoProcesarSolicitudRecuperacion,
                ...
                ["Ocurrió un error inesperado al solicitar el código de verificación."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["Los datos proporcionados no son válidos para confirmar el código."] = () => LangResources.Lang.errorTextoSolicitudVerificacionInvalida,
                ...
                ["Ocurrió un error inesperado al confirmar el código de verificación."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["Los datos de la cuenta no son válidos."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["No fue posible completar el registro de la cuenta."] = () => LangResources.Lang.errorTextoRegistrarCuentaMasTarde,
                ["Ocurrió un problema al registrar la cuenta."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["Ocurrió un error inesperado al registrar la cuenta."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud,
                ["Los datos proporcionados no son válidos para iniciar sesión."] = () => LangResources.Lang.errorTextoPrepararSolicitudInicioSesion,
                ...
                ["Ocurrió un error inesperado al iniciar sesión."] = () => LangResources.Lang.errorTextoProblemaProcesarSolicitud
            };
